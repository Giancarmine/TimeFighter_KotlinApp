...
class MainActivity : AppCompatActivity() {
    ...
    // Object to land scape mode - save state quedate
    companion object {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        gameScoreTextView = findViewById<TextView>(R.id.score_textView)
        timeLeftTextView = findViewById<TextView>(R.id.time_textView)
    ...
    override fun onSaveInstanceState(outState: Bundle) {
        ...
        Log.d(TAG, "onSaveInstanceState: Saving Score: $score and the Time Left: $timeLeftOnTimer")
    }
